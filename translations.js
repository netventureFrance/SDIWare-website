    ...
    en: {
        ...
        useCases: {
            ...
            studio: {
                ...
                desc: "Perfect for broadcast studios requiring reliable SDI to NDI conversion for multi-camera productions and live switching"
            },
            broadcast: {
                title: "Outside Broadcast Production",
                desc: "Designed for mobile production units and OB vans, enabling seamless integration of traditional SDI equipment with modern NDI workflows"
            },
            corporate: {
                title: "Live Corporate Event",
                desc: "Ideal for corporate events, conferences, and presentations requiring professional broadcast quality with flexible connectivity"
            },
            remote: {
                title: "Remote and Cloud Production",
                desc: "Enable distributed production workflows with IP-based video delivery for remote operators and cloud-based production environments"
            }
        },
        partners: {
    ...
    fr: {
        ...
        useCases: {
            ...
            studio: {
                ...
                desc: "Parfait pour les studios de diffusion nécessitant une conversion SDI vers NDI fiable pour les productions multi-caméras et la commutation en direct"
            },
            broadcast: {
                title: "Production Reportage Mobile",
                desc: "Conçu pour les unités de production mobile et les cars régies, permettant une intégration transparente des équipements SDI traditionnels avec les workflows NDI modernes"
            },
            corporate: {
                title: "Événement d'Entreprise en Direct",
                desc: "Idéal pour les événements d'entreprise, les conférences et les présentations nécessitant une qualité de diffusion professionnelle avec une connectivité flexible"
            },
            remote: {
                title: "Production Distante et Cloud",
                desc: "Permet des workflows de production distribués avec diffusion vidéo basée sur IP pour les opérateurs distants et les environnements de production cloud"
            }
        },
        partners: {
    ...
    de: {
        ...
        useCases: {
            ...
            studio: {
                ...
                desc: "Perfekt für Broadcast-Studios, die eine zuverlässige SDI-zu-NDI-Konvertierung für Mehrkamera-Produktionen und Live-Switching benötigen"
            },
            broadcast: {
                title: "Außenübertragungsproduktion",
                desc: "Entwickelt für mobile Produktionseinheiten und Übertragungswagen, ermöglicht nahtlose Integration traditioneller SDI-Ausrüstung mit modernen NDI-Workflows"
            },
            corporate: {
                title: "Live-Firmenveranstaltung",
                desc: "Ideal für Firmenveranstaltungen, Konferenzen und Präsentationen, die professionelle Broadcast-Qualität mit flexibler Konnektivität erfordern"
            },
            remote: {
                title: "Remote- und Cloud-Produktion",
                desc: "Ermöglicht verteilte Produktions-Workflows mit IP-basierter Videoübertragung für Remote-Operatoren und Cloud-basierte Produktionsumgebungen"
            }
        },
        partners: {
    ...
    es: {
        ...
        useCases: {
            ...
            studio: {
                ...
                desc: "Perfecto para estudios de transmisión que requieren conversión confiable de SDI a NDI para producciones multicámara y conmutación en vivo"
            },
            broadcast: {
                title: "Producción de Transmisión Externa",
                desc: "Diseñado para unidades de producción móvil y unidades móviles, permitiendo integración perfecta de equipos SDI tradicionales con flujos de trabajo NDI modernos"
            },
            corporate: {
                title: "Evento Corporativo en Vivo",
                desc: "Ideal para eventos corporativos, conferencias y presentaciones que requieren calidad de transmisión profesional con conectividad flexible"
            },
            remote: {
                title: "Producción Remota y en la Nube",
                desc: "Habilita flujos de trabajo de producción distribuida con entrega de video basada en IP para operadores remotos y entornos de producción en la nube"
            }
        },
        partners: {
    ...
    it: {
        ...
        useCases: {
            ...
            studio: {
                ...
                desc: "Perfetto per studi di trasmissione che richiedono conversione affidabile da SDI a NDI per produzioni multi-camera e commutazione live"
            },
            broadcast: {
                title: "Produzione Outside Broadcast",
                desc: "Progettato per unità di produzione mobile e mezzi mobili, consente un'integrazione perfetta delle apparecchiature SDI tradizionali con i flussi di lavoro NDI moderni"
            },
            corporate: {
                title: "Evento Aziendale in Diretta",
                desc: "Ideale per eventi aziendali, conferenze e presentazioni che richiedono qualità broadcast professionale con connettività flessibile"
            },
            remote: {
                title: "Produzione Remota e Cloud",
                desc: "Abilita flussi di lavoro di produzione distribuita con distribuzione video basata su IP per operatori remoti e ambienti di produzione cloud"
            }
        },
        partners: {
