    ...
    en: {
        ...
        useCases: {
            ...
            corporate: {
                ...
                desc2: "The <a href=\"https://www.mmgaxis.io\" target=\"_blank\" rel=\"noopener noreferrer\">MMG Axis</a> is a high-performance, rack-mounted AV appliance designed to be the heart of AV over IP production, bridging SDI workflows with modern NDI®️-based IP production systems. It serves as your Switcher, Signal Conversion, NDI Bridge, vMix Machine, TriCaster Machine, Live Streaming & Remote Production powerhouse. Featuring four bidirectional 3G-SDI ports (with audio embed/de-embed), 4 display ports, 10 GbE and 2.5 GbE network interfaces (plus WiFi 7), it supports real-time SDI↔️NDI conversion with ULTRA LOW latency—encoding or decoding in under 30ms. The architecture processes up to 94 NDI's at 1080p 60fps or lower volumes at higher resolutions such as 4K or 8K. It integrates natively with vMix, OBS, TriCaster and Dante, optimized and left open for you to install and run software. Suitable for in-person, Hybrid & Virtual AV Production, broadcast studios, live-event venues, remote production, education and corporate streaming.",
    ...
    fr: {
        ...
        useCases: {
            ...
            corporate: {
                ...
                desc2: "Le <a href=\"https://www.mmgaxis.io\" target=\"_blank\" rel=\"noopener noreferrer\">MMG Axis</a> est un appareil AV haute performance monté en rack, conçu pour être le cœur de la production AV sur IP, reliant les flux de travail SDI avec les systèmes de production IP modernes basés sur NDI®️. Il sert de Switcher, Conversion de Signal, Pont NDI, Machine vMix, Machine TriCaster, puissance de Streaming en Direct & Production à Distance. Doté de quatre ports 3G-SDI bidirectionnels (avec embed/de-embed audio), 4 ports d'affichage, interfaces réseau 10 GbE et 2,5 GbE (plus WiFi 7), il prend en charge la conversion SDI↔️NDI en temps réel avec une latence ULTRA FAIBLE—encodage ou décodage en moins de 30ms. L'architecture traite jusqu'à 94 NDI à 1080p 60fps ou des volumes inférieurs à des résolutions plus élevées telles que 4K ou 8K. Il s'intègre nativement avec vMix, OBS, TriCaster et Dante, optimisé et laissé ouvert pour installer et exécuter des logiciels. Convient pour la production AV en personne, hybride et virtuelle, les studios de diffusion, les lieux d'événements en direct, la production à distance, l'éducation et le streaming d'entreprise.",
    ...
    de: {
        ...
        useCases: {
            ...
            corporate: {
                ...
                desc2: "Der <a href=\"https://www.mmgaxis.io\" target=\"_blank\" rel=\"noopener noreferrer\">MMG Axis</a> ist ein leistungsstarkes, rack-montiertes AV-Gerät, das als Herzstück der AV-over-IP-Produktion konzipiert wurde und SDI-Workflows mit modernen NDI®️-basierten IP-Produktionssystemen verbindet. Es dient als Ihr Switcher, Signalkonverter, NDI-Bridge, vMix-Maschine, TriCaster-Maschine, Live-Streaming & Remote-Produktions-Kraftpaket. Mit vier bidirektionalen 3G-SDI-Ports (mit Audio-Embed/De-Embed), 4 Display-Ports, 10-GbE- und 2,5-GbE-Netzwerkschnittstellen (plus WiFi 7) unterstützt es SDI↔️NDI-Konvertierung in Echtzeit mit ULTRA NIEDRIGER Latenz—Codierung oder Decodierung in unter 30ms. Die Architektur verarbeitet bis zu 94 NDI's bei 1080p 60fps oder geringere Volumen bei höheren Auflösungen wie 4K oder 8K. Es integriert sich nativ mit vMix, OBS, TriCaster und Dante, optimiert und offen gelassen für Sie, um Software zu installieren und auszuführen. Geeignet für persönliche, hybride & virtuelle AV-Produktion, Broadcast-Studios, Live-Event-Locations, Remote-Produktion, Bildung und Unternehmens-Streaming.",
